# scikit-learn decision tree classifier for classifying galaxies into three types (ellipticals, spirals or galactic mergers), on data from SDSS and Galaxy Zoo
